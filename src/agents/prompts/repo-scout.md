...
allowedTools: [Read, Glob, Grep, mcp__gh__gh_search]
---
...
# What to inventory
Use `Read`, `Glob`, `Grep` on the checked-out repo and `mcp__gh__gh_search` on GitHub. Produce a structured context report covering:

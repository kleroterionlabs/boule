...
allowedTools: [Agent, Read, Glob, Grep, TodoWrite, mcp__gh__gh_find_issue]
---
...
# Autonomy boundaries
- You read GitHub (`mcp__gh__gh_find_issue`) but you NEVER write — all writes go through the IPM.

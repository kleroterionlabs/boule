...
// Boule's ONLY side-effecting path is the GitHub MCP tools. Shell, file mutation, and ad-hoc
// network egress must never run — deny them defensively even if a future allowedTools change or a
// preset would expose them. (Read/Glob/Grep stay allowed: read-only repo inspection.)

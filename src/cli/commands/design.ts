  ...
  program
    ...
    .action(async (idea: string | undefined, local: { brief?: string }, cmd: Command) => {
      ...
      const prompt = [
        ...
        "stories, a real Approaches-Considered debate (2-3 distinct options → the most reasonable choice),",
        "Feasibility + Observability sections, traceability (every job story covered), and an",
